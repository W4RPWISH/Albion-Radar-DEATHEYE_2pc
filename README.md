...
# Я не могу пофиксить импорты у меня лапки >*< a.k.a проект не компилится ((

Если вы не в состоянии решить такие проблемы сами, возможно вам не стоит изобретать велосипед?
1. Подкидываете в проект файл Wpf.Ui из папки Libs
2. Открываем консоль пакетов в Visual Studio, пишем команду Update-Package -reinstall
3. Делаем пасту и греем гоев на ФП
